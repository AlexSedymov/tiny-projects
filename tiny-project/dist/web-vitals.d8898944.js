...
var e, t, n, i, r = function(e1, t1) {
    ...
    var n6, i5 = function(t9) {
        ...
        if (!e12.hadRecentInput) {
            ...
            s2 && e12.startTime - i6.startTime < 1e3 && e12.startTime - t10.startTime < 5e3 ? (s2 += e12.value, m2.push(e12)) : (s2 = e12.value, m2 = [
                e12
    ...
    if (e14.cancelable) {
        var t11 = (e14.timeStamp > 1e12 ? new Date : performance.now()) - e14.timeStamp;
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["11fAR"], null, "parcelRequireae90")
